 ...
 * 
{
  ...
  "UDID": "2350437B-D31B-4C28-994A-509A4A14B976",
  "app": "/Users/bcopeland/Library/Developer/Xcode/DerivedData/PointOfSale-fyconidmwmhvlnezjcezewitchew/Build/Products/Debug-iphonesimulator/PointOfSale.app",
  "bundleId": "com.outloncollege.PointOfSale",
  "version": "1.0",
  "launchTimeout": "60000"
}
 * 
...
//	private static final String DRIVER_PATH_MAC = "/usr/bin/safaridriver"; //iOS+Safari - Mac
//	private static final String DRIVER_PATH_MAC = "/opt/TestAutomation/Selenium/WebDrivers/Chrome/chromedriver_mac/chromedriver"; //Android+Chrome - Mac
//	private static final String DRIVER_PATH_MAC = "/opt/TestAutomation/Selenium/WebDrivers/FireFox/geckodriver-v0.26.0-win64//geckodriver.exe"; //Android+FF - Windows
...
//        seleniumDriver.findElement(By.xpath("(//input[@name=\'BefOrAft\'])[0]")).click();
	...
	public static void main(String[] args) {
		AppiumTestAndroid tc = new AppiumTestAndroid();
